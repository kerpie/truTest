...
public class Register extends Activity {
	...
	private TextView btn_again, textCode;
	private Button btn_register, backButton;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_again = (TextView) findViewById(R.id.register_button_again);
		...
		if (savedInstanceState != null) {
			...
			if (!(savedPath.isEmpty())) {
				...
				// Toast.makeText(Register.this, "Vacio",
	...
	protected void onStart() {
		...
		btn_register.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				String alertMessage = "";
				if (bitmap == null || countryCode.isEmpty()
						|| productName.isEmpty()) {
					if (bitmap == null)
					...
					if (countryCode.isEmpty())
						alertMessage = alertMessage
								+ "Select the country of manufacturing";
					Toast.makeText(getApplicationContext(), alertMessage,
							Toast.LENGTH_SHORT).show();
				} else {
					if (ConstantValues
							.getConnectionStatus(getApplicationContext())) {
